...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>China Man - Barber & Hair Cutting</title>
  ...
  <header class="header">
      ...
      <div class="container">
        ...
        <ul class="header-top-list">
          ...
          <li class="header-top-item">
            ...
            <a href="tel:+220 342-5038" class="item-link">+220 342-5038</a>
          </li>
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        ...
        <a href="#" class="logo">
          China Man
          <span class="span"><span class="fi fi-gm"></span> Barber Shop <span class="fi fi-gm"></span> </span>
        </a>
    ...
    <article>
      ...
      <section class="section hero has-before has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <p class="hero-text">
            We provide the Best and Fresh Hair Cut in The Gambia
      ...
      <section class="section service" id="services" aria-label="services">
        <div class="container">
          ...
          <p class="section-text text-center">
            ask china man - ask china man ask - china man
          </p>
            ...
            <ul class="grid-list">
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="89">D 89</data>
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="45">D 45</data>
              ...
              <li data-filter="face-washing">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="35">D 35</data>
              ...
              <li data-filter="body-treatments">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="56">D 56</data>
              ...
              <li data-filter="beauty-spa">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="27">D 27</data>
              ...
              <li data-filter="face-washing">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="63">D 63</data>
              ...
              <li data-filter="body-treatments">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="43">D 43</data>
              ...
              <li data-filter="meditations">
                <div class="pricing-card">
                  ...
                  <data class="card-price" value="74">D 74</data>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./assets/images/gallery-1.jpeg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./assets/images/gallery-2.jpeg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./assets/images/gallery-3.jpeg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./assets/images/gallery-4.jpeg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
  ...
  <footer class="footer has-bg-image" style="background-image: url('./assets/images/footer-bg.jpg')">
    <div class="container">
        ...
        <div class="footer-link-box">
              ...
              <div class="blog-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-date">
                    ...
                    <time datetime="2022-08-25">12 March 2023</time>
                  </div>
                </div>
          ...
          <ul class="footer-list">
            ...
            <li class="footer-list-item">
              ...
              <a href="tel:+220 342-5038" class="contact-link">+220 342-5038</a>
            </li>

            <li class="footer-list-item">
              <ion-icon name="time-outline" aria-hidden="true"></ion-icon>

              <span class="contact-link">Sun - Sat, 08 am - 09 pm</span>
            </li>

            <li class="footer-list-item">
              <ion-icon name="mail-outline" aria-hidden="true"></ion-icon>

              <a href="mailto:info@chinamanbarbershop.com" class="contact-link">info@chinamanbarbershop.com</a>
            </li>
      ...
      <div class="footer-bottom">
        <p class="copyright">
          &copy; 2023 <a href="#" class="copyright-link">CHINA MAN BARBERSHOP - THE GAMBIA</a>. All Rights Reserved.
        </p>
      </div>
